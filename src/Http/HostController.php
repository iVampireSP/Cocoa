...
class HostController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('Cocoa::hosts.index', ['hosts' => $hosts, 'count' => $count]);
    }
    ...
    public function show(Host $host): View
    {
        ...
        return view('Cocoa::hosts.show', ['host' => $host, 'workOrders' => $workOrders]);
    }
    ...
    {
        return view('Cocoa::hosts.edit', ['host' => $host]);
    }
